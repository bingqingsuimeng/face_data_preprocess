...
from RetinaFace_Detector.rcnn.logger import logger
#from rcnn.processing.bbox_transform import nonlinear_pred, clip_boxes, landmark_pred
from RetinaFace_Detector.rcnn.processing.bbox_transform import clip_boxes
from RetinaFace_Detector.rcnn.processing.generate_anchor import generate_anchors_fpn, anchors_plane
from RetinaFace_Detector.rcnn.processing.nms import gpu_nms_wrapper, cpu_nms_wrapper
from RetinaFace_Detector.rcnn.processing.bbox_transform import bbox_overlaps

class RetinaFace:
  def __init__(self, prefix, epoch, ctx_id=-1, network='net3', nms=0.4, nocrop=False, decay4 = 0.5, vote=False):
    self.ctx_id = ctx_id
